...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-slate-500">Perbarui silabus {{ $training->title }}</p>
        </div>
    ...
    <form action="{{ route('admin.trainings.update', $training->id) }}" method="POST" class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm space-y-6">
        @csrf
        @method('PUT')

        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="client_name" required placeholder="Contoh: APPI Sumsel / PT Maju" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-xs focus:ring-2 focus:ring-[#3E5CE7] focus:outline-none" />
                </div>

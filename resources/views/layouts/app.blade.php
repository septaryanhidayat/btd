...
<body class="min-h-screen flex flex-col antialiased selection:bg-blue-600 selection:text-white transition-colors duration-300 relative">
    ...
    <footer class="border-t pt-16 pb-8 transition-colors duration-300 relative overflow-hidden" style="background-color: var(--bg-deep); border-color: var(--border);">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8 pb-8 items-start text-center md:text-left">
                
                <!-- Kolom 1: Logo & Profil (lg:col-span-3) -->
                <div class="lg:col-span-3 space-y-4 flex flex-col items-center md:items-start">
                    <a href="{{ route('home') }}" class="inline-block py-1 group" aria-label="CV. Beranda Teknologi Digital">
                        <img src="{{ asset('images/Logo-BTD.png') }}" alt="CV. Beranda Teknologi Digital" width="393" height="164" loading="lazy" decoding="async" class="logo-light-mode block h-11 w-auto max-w-[200px] object-contain mx-auto md:mx-0 hover:scale-105 transition-transform" />
                        <img src="{{ asset('images/Logo-BTD-white.png') }}" alt="CV. Beranda Teknologi Digital" width="394" height="164" loading="lazy" decoding="async" class="logo-dark-mode hidden h-11 w-auto max-w-[200px] object-contain mx-auto md:mx-0 hover:scale-105 transition-transform" />
                    </a>
                ...
                <!-- Kolom 2: Alamat (lg:col-span-3) -->
                <div class="lg:col-span-3 space-y-3.5 flex flex-col items-center md:items-start">
                    ...
                    <div class="space-y-2 pt-1 text-xs sm:text-sm font-semibold">
                        <div class="flex items-center justify-center md:justify-start gap-2.5">
                            <span class="text-[#fe6000] text-sm">📞</span>
                        ...
                        <div class="flex items-center justify-center md:justify-start gap-2.5">
                            <span class="text-[#fe6000] text-sm">✉️</span>
                ...
                <!-- Kolom 3: Sosial Media (lg:col-span-3) -->
                <div class="lg:col-span-3 space-y-3.5 flex flex-col items-center md:items-start">
                    <h4 class="font-extrabold text-sm sm:text-base tracking-wide" style="color: #fe6000;">
                        Sosial Media
                    </h4>
                    ...
                    <div class="flex items-center justify-center md:justify-start gap-2 pt-0.5">
                        ...
                        <a href="https://www.instagram.com/bteknologi_digital" target="_blank" rel="noopener noreferrer" 
                           ...
                           class="w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700/80 hover:bg-[#fe6000] hover:text-white hover:border-[#fe6000] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-xs">
                        ...
                        <a href="https://linkedin.com/company/berandadigital" target="_blank" rel="noopener noreferrer" 
                           ...
                           class="w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700/80 hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-xs">
                        ...
                        <a href="https://github.com/septaryanhidayat/btd" target="_blank" rel="noopener noreferrer" 
                           ...
                           class="w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700/80 hover:bg-slate-900 hover:text-white hover:border-slate-900 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-xs">
                        ...
                        <a href="https://www.youtube.com/@berandadigital" target="_blank" rel="noopener noreferrer" 
                           ...
                           class="w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700/80 hover:bg-red-600 hover:text-white hover:border-red-600 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-xs">
                        ...
                        <a href="https://wa.me/6289695249089" target="_blank" rel="noopener noreferrer" 
                           ...
                           class="w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-700/80 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-xs">
                ...
                <!-- Kolom 4: Pengunjung Live (lg:col-span-3, Sesuai Referensi Gambar 2) -->
                <div class="lg:col-span-3 space-y-2 flex flex-col items-center md:items-start"
                     x-data="{

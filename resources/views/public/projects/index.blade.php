                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group">
                    ...
                    <div>
                        <div class="h-48 sm:h-52 w-full overflow-hidden relative border-b border-slate-100 dark:border-slate-800 bg-slate-950 cursor-pointer group/img"
                            ...
                            <div class="absolute top-2.5 left-2.5 z-10 pointer-events-none">
                                <span class="px-2.5 py-0.5 rounded-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-md text-[#3E5CE7] dark:text-blue-400 font-extrabold text-[10px] border border-blue-100 dark:border-blue-900/60 shadow-xs line-clamp-1 max-w-[180px]">
                                    {{ $badgeCategory }}
                                </span>
                            </div>
                        ...
                        <div class="p-4 sm:p-5 space-y-2.5">
                            ...
                            <!-- Title -->
                            <h3 class="text-sm sm:text-[15px] font-extrabold text-[#07153f] dark:text-white group-hover:text-[#3E5CE7] dark:group-hover:text-blue-400 transition-colors leading-snug line-clamp-1" title="{{ $displayTitle }}">
                                {{ $displayTitle }}
                            </h3>
                    ...
                    <div class="p-4 sm:p-5 pt-0 space-y-2">
                        <div class="pt-2.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2">
                            <button type="button"
                                    @click="openModal('{{ addslashes($displayTitle) }}', '{{ addslashes($project->client_name) }}', '{{ $project->app_type ?? 'web' }}', '{{ $waProductUrl }}', {{ $slidesJson }})"
                                    class="text-[11.5px] font-bold text-[#3E5CE7] dark:text-blue-400 hover:underline flex items-center gap-1">
                                <span>🔍 Layar UI</span>
                            </button>
